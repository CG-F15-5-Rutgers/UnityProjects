	...
	protected Node ST_GatherDanceParty(Transform target1, Transform target2, Transform target3, Transform target4)
	{
		...
		return new Sequence (
			...
			new SequenceParallel(danceParticipant.GetComponent<BehaviorMecanim>().Node_OrientTowards(position4), new LeafWait(1000),
		                     danceParticipant2.GetComponent<BehaviorMecanim>().Node_OrientTowards(position4), new LeafWait(1000),
		                     danceParticipant3.GetComponent<BehaviorMecanim>().Node_OrientTowards(position4), new LeafWait(1000)),

			new SequenceParallel(danceParticipant.GetComponent<BehaviorMecanim>().Node_GoTo(position1), new LeafWait(1000),
		                     	danceParticipant2.GetComponent<BehaviorMecanim>().Node_GoTo(position2), new LeafWait(1000),
		                     	danceParticipant3.GetComponent<BehaviorMecanim>().Node_GoTo(position3), new LeafWait(1000)),
