...
public class BehaviorMecanim : MonoBehaviour
{
	...
	public Node Node_FallOffSnail()
	{
		return new LeafInvoke(
			() => this.Character.NavFallOffSnail());
		
	}

	public Node Node_RideSnail()
	{
		return new LeafInvoke(
			() => this.Character.NavRideSnail());
	}

	public Node Node_DismountSnail()
	{
		return new LeafInvoke(
			() => this.Character.NavDismountSnail());
	}

	public Node Node_DestroySnail()
	{
		return new LeafInvoke(
			() => this.Character.NavDestroySnail());
	}

	public Node Node_SnailTrick1()
	{
		return new LeafInvoke(
			() => this.Character.NavSnailTrick1());
	}

	public Node Node_SnailTrick2()
	{
		return new LeafInvoke(
			() => this.Character.NavSnailTrick2());
	}

	public Node Node_SnailTrick3()
	{
		return new LeafInvoke(
			() => this.Character.NavSnailTrick3());
	}



	public Node Node_PushBox()
	{
		return new LeafInvoke(
			() => this.Character.NavPushBox());
	}

	public Node Node_DancePolka()
	{
		return new LeafInvoke(
			() => this.Character.NavPolka());
	}

	public Node Node_DanceElectronic1()
	{
		return new LeafInvoke(
			() => this.Character.NavElectronic1());
	}

	public Node Node_DanceElectronic2()
	{
		return new LeafInvoke(
			() => this.Character.NavElectronic2());
	}

	public Node Node_DanceMetal1()
	{
		return new LeafInvoke(
			() => this.Character.NavMetal1());
	}

	public Node Node_DanceMetal2()
	{
		return new LeafInvoke(
			() => this.Character.NavMetal2());
	}

	public Node Node_DanceMetal3()
	{
		return new LeafInvoke(
			() => this.Character.NavMetal3());
	}

	public Node Node_Flex1()
	{
		return new LeafInvoke(
			() => this.Character.NavFlex1());
	}
	
	public Node Node_Flex2()
	{
		return new LeafInvoke(
			() => this.Character.NavFlex2());
	}
	
	public Node Node_Flex3()
	{
		return new LeafInvoke(
			() => this.Character.NavFlex3());
	}

	public Node Node_Squat()
	{
		return new LeafInvoke (
			() => this.Character.NavSquat ());
	}

	public Node Node_Breakdance()
	{
		return new LeafInvoke (
			() => this.Character.NavBreakdance ());
	}

	public Node Node_FightWin()
	{
		return new LeafInvoke (
			() => this.Character.NavFightWin ());
	}

	public Node Node_FightLose()
	{
		return new LeafInvoke (
			() => this.Character.NavFightLose ());
	}


    public Node Node_NudgeTo(Val<Vector3> targ, float time)
    {
        return new LeafInvoke(
            () => this.Character.NavNudgeTo(targ, time),
            () => this.Character.NavStop());
    }
